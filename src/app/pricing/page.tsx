...
export default function PricingPlansPage() {
  ...
  const { data: settingsData } = useSWR("settings", fetchers.publicSettings);
  const { data: menuData } = useSWR("headerMenu", fetchers.publicMenus);
  ...
  if (isLoading) {
    return (
      <>
        <SiteNavbar settings={settingsData?.data} headerMenu={menuData?.data} />
